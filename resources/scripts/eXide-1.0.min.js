...
0),d=f;d<=e;d++)f=a.getLine(d),g.start.row=d,g.end.row=d,g.end.column=f.length,a.replace(g,b?f.match(c)[1]:"<\!--"+f+"--\>")}}).call(i.prototype);b.Mode=i});var eXide=eXide||{};eXide.namespace=function(a){var a=a.split("."),b=eXide,c;"eXide"==a[0]&&(a=a.slice(1));for(c=0;c<a.length;c++)"undefined"==typeof b[a[c]]&&(b[a[c]]={}),b=b[a[c]];return b};eXide.namespace("eXide.util");
