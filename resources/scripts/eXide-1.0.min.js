...
initGUI:function(){$("body").layout({enableCursorHotkey:!1,north__size:70,north__resizable:!1,north__closable:!0,north__showOverflowOnHover:!0,south__minSize:200,south__initClosed:!0,west__size:200,west__initClosed:!0,west__contentSelector:".content",center__minSize:300,center__onresize:eXide.app.resize,center__contentSelector:".content"});var b=new eXide.util.Menubar($(".menu"));$("#open-dialog").dialog({title:"Open File",modal:!1,autoOpen:!1,height:480,width:700,open:function(){d.init()},resize:function(){d.resize()}});
$("#preferences-dialog").dialog({title:"Preferences",modal:!0,autoOpen:!1,height:400,width:600,buttons:{Cancel:function(){$(this).dialog("close");a.focus()},Save:function(){var b=$("form",this);h.theme=$('select[name="theme"]',b).val();h.fontSize=$('select[name="font-size"]',b).val();h.showInvisibles=$('input[name="show-invisibles"]',b).is(":checked");h.showPrintMargin=$('input[name="print-margin"]',b).is(":checked");b=$('select[name="soft-wrap"]',b).val();b==="free"?b=-1:b==="off"&&(b=0);h.softWrap=
parseInt(b);eXide.app.applyPreferences();$(this).dialog("close");a.focus()}}});$("#login-dialog").dialog({title:"Login",modal:!0,autoOpen:!1,buttons:{Login:function(){$.ajax({url:"login",data:$("#login-form").serialize(),success:function(){eXide.app.login=$('#login-form input[name="user"]').val();$.log("Logged in as %s",eXide.app.login);$("#login-dialog").dialog("close");$("#user").text("Logged in as "+eXide.app.login+". ");$("#login").text("Logout");setTimeout(function(){eXide.app.ping()},3E4);a.focus()},
error:function(){$("#login-error").text("Login failed. Bad username or password.");$("#login-dialog input:first").focus()}})},Cancel:function(){$(this).dialog("close");a.focus()}},open:function(){$(this).find("input").val("");$(this).find("input:first").focus();$("#login-error").empty();var a=$(this);a.find("input").keyup(function(b){b.keyCode==13&&a.parent().find(".ui-dialog-buttonpane button:first").trigger("click")})}});$("#keyboard-help").dialog({title:"Keyboard Shortcuts",modal:!1,autoOpen:!1,
height:400,buttons:{Close:function(){$(this).dialog("close")}},open:function(){eXide.edit.commands.help($("#keyboard-help"),a)}});$("#about-dialog").dialog({title:"About",modal:!1,autoOpen:!1,height:300,width:450,buttons:{Close:function(){$(this).dialog("close")}}});var c=$("#open").button({icons:{primary:"ui-icon-folder-open"}});c.click(eXide.app.openDocument);b.click("#menu-file-open",eXide.app.openDocument);c=$("#close").button({icons:{primary:"ui-icon-close"}});c.click(eXide.app.closeDocument);
b.click("#menu-file-close",eXide.app.closeDocument);c=$("#new").button({icons:{primary:"ui-icon-document"}});c.click(eXide.app.newDocument);b.click("#menu-file-new",eXide.app.newDocument);c=$("#run").button({icons:{primary:"ui-icon-play"}});c.click(eXide.app.runQuery);c=$("#validate").button({icons:{primary:"ui-icon-check"}});c.click(eXide.app.checkQuery);c=$("#save").button({icons:{primary:"ui-icon-disk"}});c.click(eXide.app.saveDocument);b.click("#menu-file-save",eXide.app.saveDocument);b.click("#menu-file-save-as",
eXide.app.saveDocumentAs);c=$("#download").button({icons:{primary:"ui-icon-transferthick-e-w"}});c.click(eXide.app.download);b.click("#menu-file-download",eXide.app.download);b.click("#menu-file-manager",eXide.app.manage);b.click("#menu-deploy-new",eXide.app.newDeployment);b.click("#menu-deploy-edit",eXide.app.deploymentSettings);b.click("#menu-deploy-deploy",eXide.app.deploy);b.click("#menu-deploy-sync",eXide.app.synchronize);b.click("#menu-deploy-download",eXide.app.downloadApp);b.click("#menu-edit-undo",
function(){a.editor.undo()});b.click("#menu-edit-redo",function(){a.editor.redo()});b.click("#menu-edit-toggle-comment",function(){a.editor.toggleCommentLines()});b.click("#menu-edit-preferences",eXide.app.preferences);b.click("#menu-navigate-definition",function(){a.exec("gotoDefinition")});b.click("#menu-navigate-modules",function(){var b=a.getActiveDocument();eXide.find.Modules.select(b.syntax)});b.click("#menu-deploy-run",eXide.app.openApp);b.click("#menu-help-keyboard",function(){$("#keyboard-help").dialog("open")});
b.click("#menu-help-about",function(){$("#about-dialog").dialog("open")});b.click("#menu-help-hints",function(){eXide.util.Help.show()});$("#syntax").change(function(){a.setMode($(this).val())});a.addEventListener("activate",null,function(a){$("#syntax").val(a.getSyntax())});$("#login").click(function(a){a.preventDefault();eXide.app.login?($.get("logout"),$("#user").empty(),$("#login").text("Login"),eXide.app.login=null):$("#login-dialog").dialog("open")});$("#results-container .next").click(eXide.app.browseNext);
...
a[c];e.updateRowCount();e.render();e.setActiveCell(0,0);e.setSelectedRows([0]);$("#module-list").find(".grid-canvas").focus()})},addEventListener:function(b,c,d){(b=a[b])&&b.push({obj:c,callback:d})},$triggerEvent:function(b,c){var d=a[b];if(d)for(var e=0;e<d.length;e++)d[e].callback.apply(d[e].obj,c)}}}();eXide.namespace("eXide.util.Menubar");eXide.util.Menubar=function(){Constr=function(a){this.container=a;$("ul li",this.container).click(function(){var a=this;$("ul",this).css({visibility:"visible",display:"none"}).show(400);$(this).mouseleave(function(){$("ul",a).css({visibility:"hidden"})})})};Constr.prototype.click=function(a,c){var d=this;$(a).click(function(a){a.preventDefault();c();$("ul",d).css({visibility:"hidden"})})};return Constr}();